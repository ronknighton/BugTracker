$(document).ready(function(){
    ...
    $(function () {
        $("#customScroll").niceScroll({ cursorcolor: "#000" });
    });
    $(".fixed-height, .fixed").niceScroll({ styler: "fb", cursorcolor: "#00000", cursorwidth: '10', cursorborderradius: '10px', background: '#404040', spacebarenabled: false, cursorborder: '' });
   

    $("html").niceScroll({ styler: "fb", cursorcolor: "#00000", cursorwidth: '10', cursorborderradius: '10px', background: '#404040', spacebarenabled: false, cursorborder: '', zindex: '1000' });
    /* --------------------------------------------------------
